...
M.general = {
	n = {
		...
		["<C-Right>"] = { ":vertical resize +5<cr>", opts = { silent = true } },
		["<C-Left>"] = { ":vertical resize -5<cr>", opts = { silent = true } },
		["<C-Up>"] = { ":resize +5<cr>", opts = { silent = true } },
		["<C-Down>"] = { ":resize -5<cr>", opts = { silent = true } },
